...
(checkout.html)[/store/static/store/gallery/checkout.png]
(order_success.html)[/store/static/store/gallery/order_success.png]
(profile.html)[/store/static/store/gallery/profile.png]
